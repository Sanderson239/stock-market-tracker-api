...
// WARNING: this is not tested today_market_ca
// this one averages the daily percent and absolute gains and losses
// as opposed to how much I would gain and lose according to puts and calls
...
class Picks {
  ...
  addCompanyDataAndPickIds(pickId, companyIds) {
    let dataToAdd = [];
    for (let i = 0; i < companyIds.length; i++) {
      dataToAdd[i] = {pick_id: pickId, company_id: companyIds[i]}
    }
  return knex('company_data_picks')
    .insert(decamelizeKeys(dataToAdd), '*')
