  ...
  getPicksByFilter(data) {
    ...
    .then(result => {
      ...
      .then(newResult => {
        ...
        //   data.company_data[`${newResult[i].company_id}`].changePercentage = calculatePercentage((data.company_data[`${newResult[i].company_id}`][`${data.buy_period}`]), data.company_data[`${newResult[i].company_id}`][`${data.sell_period}`]) * 100;
        ...
        //   data.changePercentage.push(data.company_data[`${newResult[i].company_id}`].changePercentage);
        //   data.changeAbsolute.push(data.company_data[`${newResult[i].company_id}`].changeAbsolute);
        }
        console.log('company ids', data.company_ids);
